...
const routes: Routes = [
  { path: '', component: PatientsComponent, data: { breadcrumb: 'Pacientes' },
    children:[
      ...
      { path: 'psychoterapy/list', component: PsychoterapyPatientListViewComponent, data: { breadcrumb: 'Psicoterapia' } },
      ...
      { path: 'early-stimulation/list', component: EarlyStimulationPatientListViewComponent, data: { breadcrumb: 'Estimulación Temprana' } },
      ...
      { path: 'neuro-psychology/list', component: NeuroPsychologyPatientListViewComponent, data: { breadcrumb: 'Neuro Psicología' } },
