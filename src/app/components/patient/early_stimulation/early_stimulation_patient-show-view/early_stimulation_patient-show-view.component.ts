...
@Component({
  selector: 'app-early_stimulation_patient-show-view',
  templateUrl: './early_stimulation_patient-show-view.component.html',
  styleUrls: ['./early_stimulation_patient-show-view.component.scss']
})
