...
@Component({
  selector: 'patient_early_stimulation-select',
  templateUrl: './patient_early_stimulation-select.component.html',
  styleUrls: ['./patient_early_stimulation-select.component.scss']
})
export class PatientEarlyStimulationSelectComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  current_patient = {
    ...
    address: '', gender: '', birthplace: '', date_of_birth: '', residence_location: ''
 }
  ...
  buildPatientList(patientList: any[]){
    return patientList.filter((obj:any) => obj.early_stimulation_patient != null).map( (obj:any) => ({
      ...obj, 
      type:
