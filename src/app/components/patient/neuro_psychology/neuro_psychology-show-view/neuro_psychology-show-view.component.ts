...
@Component({
  selector: 'app-neuro_psychology-show-view',
  templateUrl: './neuro_psychology-show-view.component.html',
  styleUrls: ['./neuro_psychology-show-view.component.scss']
})
export class NeuroPsychologyShowViewComponent implements OnInit, OnDestroy, AfterViewInit {
