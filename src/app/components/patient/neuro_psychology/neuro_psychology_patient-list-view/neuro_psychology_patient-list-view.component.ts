...
@Component({
  selector: 'app-neuro_psychology_patient-list-view',
  templateUrl: './neuro_psychology_patient-list-view.component.html',
  styleUrls: ['./neuro_psychology_patient-list-view.component.scss']
})
export class NeuroPsychologyPatientListViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.utilService.set({name:'neuro-psychology', type:'list'});
  ...
  getAll(data_search:any){
    ...
    this.backendService.getAll(PATIENT.NEURO_PSYCHOLOGY, data_search).subscribe({
  ...
  viewRecord(emotion:any){
    this.router.navigate(['main','patients','neuro-psychology','show',emotion.id]);
  }
