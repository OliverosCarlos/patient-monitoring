...
@Component({
  selector: 'app-social_area-form-view',
  templateUrl: './social_area-form-view.component.html',
  styleUrls: ['./social_area-form-view.component.scss']
})
export class SocialAreaFormViewComponent implements OnInit, OnDestroy, AfterViewInit {
