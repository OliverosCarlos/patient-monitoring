...
@Component({
  selector: 'app-behavior-form-view',
  templateUrl: './behavior-form-view.component.html',
  styleUrls: ['./behavior-form-view.component.scss']
})
export class BehaviorFormViewComponent implements OnInit, OnDestroy, AfterViewInit {
