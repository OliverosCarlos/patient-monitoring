...
@Component({
  selector: 'app-family_area-form-view',
  templateUrl: './family_area-form-view.component.html',
  styleUrls: ['./family_area-form-view.component.scss']
})
export class FamilyAreaFormViewComponent implements OnInit, OnDestroy, AfterViewInit {
