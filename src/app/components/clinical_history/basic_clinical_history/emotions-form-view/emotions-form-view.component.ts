...
@Component({
  selector: 'app-emotions-form-view',
  templateUrl: './emotions-form-view.component.html',
  styleUrls: ['./emotions-form-view.component.scss']
})
export class EmotionsFormViewComponent implements OnInit, OnDestroy, AfterViewInit {
