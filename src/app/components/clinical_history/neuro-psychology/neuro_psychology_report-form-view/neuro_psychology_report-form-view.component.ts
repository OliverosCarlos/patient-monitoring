...
@Component({
  selector: 'app-neuro_psychology_report-form-view',
  templateUrl: './neuro_psychology_report-form-view.component.html',
  styleUrls: ['./neuro_psychology_report-form-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class NeuroPsychologyReportFormViewComponent implements OnInit, OnDestroy, AfterViewInit {
